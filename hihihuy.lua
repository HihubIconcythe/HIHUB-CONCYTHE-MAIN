print("huy dz and hihub")
print("ez main hihub")
Hi hub ocal Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Yellow> Loading <HI Hub> <Color=/>"):Display()
Notification.new("<Color=Red> Made by hi<Color=/>"):Display()
Notification.new("<Color=Blue> https://discord.com/invite/42bJ5BFUFm <Color=/>"):Display()
-------------------// I Write... \\----------------------------------------
...
local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/Jackermissyou/Hi Hub/main/ui.lua')))()
local Window = OrionLib:MakeWindow({Name = "Hi Hub Blox Fruit", HidePremium = false,IntroText = "Hi  Hub", SaveConfig = true, ConfigFolder = "Hi Hub"})
...
Notify("Welcome To Hi Hub Release",5)
